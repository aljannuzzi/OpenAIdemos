...
# Get the OpenAI API key from a file 123
# Testing
...
for filename in os.listdir('./sources'):
    with open(os.path.join('./sources', filename), 'r') as file:
        ...
        response = openai.Completion.create(
            ...
            prompt=f"Do a code review in a pull request review style for this code:\n\n{code_snippet}",
            max_tokens=1024,
            n=1,
            stop=None,
            temperature=0.7,
